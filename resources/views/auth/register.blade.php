            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row"  id="tcnlg">
                            <label for="technology" class="col-md-4 col-form-label text-md-right">{{ __('Technologies') }}</label>

                            <div class="col-md-6">
                                <input id="technology" type="text" class="form-control @error('technology') is-invalid @enderror" name="technology" value="{{ old('technology') }}" required autocomplete="technology" autofocus>
